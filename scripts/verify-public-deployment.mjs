...
const slugs = new Set();
const allowedBundleIDs = new Set(["com.philippgraef.rly", "de.philippgraef.foxievoyage", "com.philippgraef.rynolo", "io.github.pg-apps.thirty", "de.philippgraef.RechtMedizinisch", "com.pgapps.orydo"]);
